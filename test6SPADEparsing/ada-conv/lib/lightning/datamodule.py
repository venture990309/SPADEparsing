...
class DataModule(pl.LightningDataModule):
    ...
    def add_argparse_args(parent_parser):
        ...
        parser.add_argument('--test-content', type=str, default='../data/hj/Projects/new_task/Pose-Transfer/fashion_data/vala/testp',
                            help='Directory with test content images (or path to single image). If not set, takes 5 random train content images.')
        parser.add_argument('--test-style', type=str, default='/data/hj/Projects/new_task/Pose-Transfer/fashion_data/test22',
